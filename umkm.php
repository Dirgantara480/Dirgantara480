...
$query  = $conn->query("SELECT kategori.* ,artikel.* FROM artikel LEFT JOIN kategori on artikel.id_kategori = kategori.id_kategori ORDER BY artikel.id_kategori  DESC ");
$data   = $query->fetch();
?>
      ...
      <div class="umkm_section">
        <?php do{ ?>
          <div class="grid">
            ...
            <div class="read-more">
              <div class="judul">
                <h3><a href="lihat_artikel.php?id=<?=$data['id_kategori'];?>"><?=$data['judul_artikel'];?></a></h3>
              </div>
              <div class="attr">
                <p>
